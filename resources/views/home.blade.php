...
@section('content')
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-7">
                            ...
                            <h3 class="hero-title" data-aos="fade-up">
                                Launch Your <span class="color-liner-004ED0">Career with Industry-Ready</span> IT Training
                            </h3>

                            <!-- Subtitle -->
                            <p class="hero-subtitle" data-aos="fade-up" data-aos-delay="100">
                                Learn from industry experts, build real-world projects, gain hands-on experience, and become
                                job-ready with practical training programs designed for today's technology industry.
                            </p>

                            <!-- CTA Buttons -->
                            <div class="d-flex flex-column flex-sm-row gap-3 mb-5 mt-5" data-aos="fade-up"
                                data-aos-delay="200">
                                <a href="#contact" class="btn btn-gradient">
                                    Browse All Courses
                                    <i class="bi bi-arrow-right ms-2"></i>
                                </a>
                                <a href="#contact" class="btn btn-glass">Enroll Now</a>
                            </div>
                ...
                <div class="px-3">
                    <div class="row align-items-center">
                        <div class="col-lg-7 ">
                            ...
                            <!-- Subtitle -->
                            <p class="hero-subtitle" data-aos="fade-up" data-aos-delay="100">
                                Build responsive websites, web applications, APIs, and enterprise-level projects using
                                Laravel, React, Node.js, MySQL, MongoDB, Git, and modern development tools.
                            </p>
                ...
                <div class="px-3">
                    <div class="row align-items-center">
                        <div class="col-lg-7 ">
                            ...
                            <!-- Title -->
                            <h3 class="hero-title" data-aos="fade-up">
                                Learn AI, Machine <span class="color-liner-004ED0">Learning, Cloud & Emerging
                                    Technologies</span>
                            </h3>

                            <!-- Subtitle -->
                            <p class="hero-subtitle" data-aos="fade-up" data-aos-delay="100">
                                Get hands-on training in Artificial Intelligence, Machine Learning, AWS Cloud Computing,
                                DevOps, and Data Science while working on industry-focused projects and case studies.
                            </p>
    ...
    <section class="py-5">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-3">
                    <h3 class="text-center mb">Technologies You Will Master</h3>
                </div>
                <div class="col-md-9 ">
        ...
        <div class="container">
            <div class="mb-5">
                <div class="row align-items-end">
                    <div class="col-md-7">
                        <div class="">
                            <h2 data-aos="fade-up" class="aos-init aos-animate">Master Job-Ready Skills with Hands-On
                                Learning</h2>
                            <p class="section-subtitle aos-init aos-animate" data-aos="fade-up" data-aos-delay="100">
                                Learn by building real projects, guided by industry experts, and gain the confidence to
                ...
                @foreach ($courses as $course)
                    <div class="col-lg-3">
                        <div class="glass-card p-4 h-100">
                            <div>
                                <img class="course-card-img rounded-3"
                                    src="{{ url('/public/storage/' . $course->hero_image) }}" alt="{{ $course->title }}">
                            </div>
                            <h5>{{ $course->title }}</h5>
                            ...
                            <a href="{{ url('/training/' . $course->slug) }}"
                                class="btn btn-white w-100 justify-content-center color-liner-004ED0" tabindex="0">View
                                more</a>
                        </div>
