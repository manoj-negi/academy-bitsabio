...
@section('content')
    ...
    <!-- ========== STATS ========== -->
    <div id="stats-section-1" class="info-lable">
        <div class="container">
    ...
    <section id="solutions" class="py-5 position-relative">
        <div class="container">
            <div class="section-header" data-aos="fade-up">
                ...
                <p class="section-subtitle">Learn practical skills, build real projects, and get guided support to grow
                    from beginner to job-ready.</p>
            </div>
