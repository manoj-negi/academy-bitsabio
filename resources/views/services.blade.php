...
@section('meta_description', 'Explore BitSabio services including web development, AI solutions, UI/UX design, SEO
            ...
            <div class="row align-items-center">
                <div class="col-md-7">
                    ...
                    <p data-aos="fade-up" data-aos-delay="100">
                        Expertly designing, developing, and deploying intelligent systems that drive measurable business
                    ...
                    <div class="col-md-7">
                        <div class="">
                            ...
                            <p class="section-subtitle" data-aos="fade-up" data-aos-delay="100">
                                We don't just build software; we architect the digital future of your enterprise through
                                precision engineering and advanced intelligence.
                            </p>
                        </div>
                    </div>
                    <div class="col-md-5">
                        ...
                        <div class="glass-card p-4 h-100">
                            <div>
                                <img class="course-card-img rounded-3"
                                    src="{{ url('/public/storage/' . $service->hero_image) }}"
                                    alt="{{ $service->title }}">
                            </div>
                            <h5>{{ $service->title }}</h5>
        ...
        <div class="container">
            ...
            <div class="container py-4">
                <div class="row text-center justify-content-between">
                    ...
                    <!-- Step 1 -->
                    <div class="col">
                        <div class="bg-primary text-white rounded-3 shadow p-3 d-inline-flex align-items-center justify-content-center mb-3"
                    ...
                    <div class="">
                        ...
                        <div class="h-100">
                            <div class="innovators-card" data-aos="fade-up" data-aos-delay="100">
                                ...
                                <div>
                                    ...
                                    <p>We move beyond sandbox demos to production systems that solve actual business
                                        bottlenecks.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="h-100">
                            <div class="innovators-card" data-aos="fade-up" data-aos-delay="200">
                                ...
                                <div>
                                    <h5>Scalable MVP</h5>
                                    <p>Build fast, but build right. Our MVPs are architected to scale without needing a
                                        total rewrite.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="h-100">
                            <div class="innovators-card" data-aos="fade-up" data-aos-delay="300">
                                ...
                                <div>
                                    ...
                                    <p>Technology is the tool, ROI is the goal. We align every technical decision with your
    ...
    <section class="py-5">
        <div class="container">
            <div class="cta-banner-2" data-aos="fade-up">
                ...
                <p class="text-white mb-3">Let's discuss your challenges and find the right AI solution for your business
                </p>
