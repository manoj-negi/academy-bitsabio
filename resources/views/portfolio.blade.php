...
@section('meta_description', 'Explore BitSabio portfolio showcasing successful web development, AI projects, branding,
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-8">
                    ...
                    <h1 data-aos="fade-up">Selected Projects That Deliver <span class="color-liner-004ED0">Real Business
                            Impact</span></h1>
                    <p data-aos="fade-up" data-aos-delay="100">
                        From AI products to modern web platforms, we build scalable digital experiences that improve
                        performance, automate workflows, and accelerate growth.
                    </p>
            ...
            <div class="row g-4">
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="service-card-compact h-100">
                        ...
                        <p>
                            Built a secure RAG-powered assistant for an operations team to search SOPs, policies, and
                            tickets in seconds, reducing manual query handling by 62%.
                        </p>
                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                    <div class="service-card-compact h-100">
                        ...
                        <p>
                            Rebuilt storefront architecture and checkout flows to improve conversion rate by 34% and cut
                            page load time from 4.2s to 1.7s on mobile.
                        </p>
                        <div class="tech-stack mt-3">
                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="300">
                    <div class="service-card-compact h-100">
                        ...
                        <p>
                            Delivered an executive dashboard that unified finance, sales, and support data, enabling
                            leadership to make weekly decisions using live KPI alerts.
                        </p>
                        <div class="tech-stack mt-3">
                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="400">
                    <div class="service-card-compact h-100">
                        ...
                        <p>
                            Migrated legacy infrastructure to a cloud-native setup with CI/CD and monitoring, improving
                            release frequency and achieving 99.9% uptime.
                        </p>
                        <div class="tech-stack mt-3">
